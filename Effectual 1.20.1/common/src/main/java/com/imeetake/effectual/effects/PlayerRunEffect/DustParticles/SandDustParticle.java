...
public class SandDustParticle extends RunDustParticle {
    ...
    public SandDustParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz) {
        super(level, x, y, z, vx, vy, vz, Weight.LIGHT, 0.9F, 0.8F, 0.5F);
    }
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            SandDustParticle p = new SandDustParticle(level, x, y, z, dx, dy, dz);
