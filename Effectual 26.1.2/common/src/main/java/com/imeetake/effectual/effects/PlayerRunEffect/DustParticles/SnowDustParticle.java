...
public class SnowDustParticle extends RunDustParticle {
    ...
    public SnowDustParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, TextureAtlasSprite sprite) {
        super(level, x, y, z, vx, vy, vz, Weight.LIGHT, 1.0F, 1.0F, 1.0F, sprite);
    }
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz, RandomSource random) {
            return new SnowDustParticle(level, x, y, z, dx, dy, dz, this.spriteSet.get(random));
        }
    }
}