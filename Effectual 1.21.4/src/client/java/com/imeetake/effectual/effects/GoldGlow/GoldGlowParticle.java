...
public class GoldGlowParticle extends TOrientedParticle<TParticleEffectSimple> {
    ...
    public GoldGlowParticle(ClientWorld world,
        ...
        this.maxAge = 56 + random.nextInt(20);
        this.setAlpha(0.0F);
