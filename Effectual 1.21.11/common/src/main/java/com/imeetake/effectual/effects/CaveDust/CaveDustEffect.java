...
public class CaveDustEffect {
    ...
    private static boolean isArtificialBlock(BlockState state) {
        ...
        return b == Blocks.COPPER_BLOCK
                || b == Blocks.EXPOSED_COPPER
                || b == Blocks.WEATHERED_COPPER
                || b == Blocks.OXIDIZED_COPPER
                || b == Blocks.WAXED_COPPER_BLOCK
                || b == Blocks.WAXED_EXPOSED_COPPER
                || b == Blocks.WAXED_WEATHERED_COPPER
                || b == Blocks.WAXED_OXIDIZED_COPPER
                || b == Blocks.CUT_COPPER
                || b == Blocks.EXPOSED_CUT_COPPER
                || b == Blocks.WEATHERED_CUT_COPPER
                || b == Blocks.OXIDIZED_CUT_COPPER
                ...
                || b == Blocks.COPPER_GRATE
                || b == Blocks.EXPOSED_COPPER_GRATE
                || b == Blocks.WEATHERED_COPPER_GRATE
                || b == Blocks.OXIDIZED_COPPER_GRATE
                ...
                || b == Blocks.COPPER_BULB
                || b == Blocks.EXPOSED_COPPER_BULB
                || b == Blocks.WEATHERED_COPPER_BULB
                || b == Blocks.OXIDIZED_COPPER_BULB
                ...
                || b == Blocks.COPPER_DOOR
                || b == Blocks.EXPOSED_COPPER_DOOR
                || b == Blocks.WEATHERED_COPPER_DOOR
                || b == Blocks.OXIDIZED_COPPER_DOOR
                ...
                || b == Blocks.COPPER_TRAPDOOR
                || b == Blocks.EXPOSED_COPPER_TRAPDOOR
                || b == Blocks.WEATHERED_COPPER_TRAPDOOR
                || b == Blocks.OXIDIZED_COPPER_TRAPDOOR
                ...
                || b == Blocks.CHISELED_COPPER
                || b == Blocks.EXPOSED_CHISELED_COPPER
                || b == Blocks.WEATHERED_CHISELED_COPPER
                || b == Blocks.OXIDIZED_CHISELED_COPPER
                || b == Blocks.WAXED_CHISELED_COPPER
                || b == Blocks.WAXED_EXPOSED_CHISELED_COPPER
                || b == Blocks.WAXED_WEATHERED_CHISELED_COPPER
                || b == Blocks.WAXED_OXIDIZED_CHISELED_COPPER
                || b == Blocks.TRIAL_SPAWNER
                || b == Blocks.VAULT
                || b == Blocks.SPAWNER
                || b == Blocks.CHISELED_TUFF
                || b == Blocks.POLISHED_TUFF
                || b == Blocks.TUFF_BRICKS
                || b == Blocks.CHISELED_TUFF_BRICKS
