...
public final class MetalSparkTargets {
    ...
    private static final String ITEMS_RESOURCE = "/data/effectual/tags/item/metal_items.json";
    private static final String BLOCKS_RESOURCE = "/data/effectual/tags/block/metal_blocks.json";
