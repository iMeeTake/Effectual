...
public class WaterDripParticle extends TextureSheetParticle {
    ...
    public WaterDripParticle(ClientLevel level, Player player, double localOffsetX, double localOffsetY, double localOffsetZ, SpriteSet spriteSet) {
        super(level, player.getX(), player.getY() + localOffsetY, player.getZ(), 0, 0, 0);
        this.player = player;
